...
const Price = () => {
  return (
    <div id="shop" className="pt-16 pb-16 bg-gray-950">
      <div className="w-[80%] mx-auto grid grid-cols-1 xl:grid-cols-2 gap-10 items-center  ">
        <div>
          ...
          <p className="text-white font-medium text-opacity-70">
            ...
            dolore dolorum vitae saepe neque, temporibus corporis odio eos
            nesciunt itaque cumque nisi doloribus beatae? Necessitatibus
            voluptate exercitationem ad iste tempore?
          </p>
          <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div data-aos="fade-right" data-aos-anchor-placements="top-center">
                <PriceCard price="4" user="1" type="Silver Pack" />
            </div>
             <div data-aos="fade-right" data-aos-delay="100" data-aos-anchor-placements="top-center">
